...
GPT-4 留下的，是一张由发布方组织的性能轮廓：专业考试分数更高，图像输入已经演示，幻觉和推理错误仍在；安全训练改变了部分行为，却没有提供可靠性保证。对使用者来说，它提高了复杂写作、编程与分析任务上的可用上限；对行业来说，它巩固了一种新的发布惯例——用榜单与产品档位说话，用沉默保护训练细节。把 GPT-4 放回 2023 年春天的产品现场，还能看见更细的使用边界。ChatGPT 里的 GPT-4 与 API 里的 GPT-4 共享家族名称，但排队、速率、价格与是否立刻支持图像并不相同；合作方演示的视觉能力，不能直接写成“所有开发者当天可用”。系统卡与安全材料讨论了更难的滥用场景与缓解尝试，它们同样是发布方的测试账本，而不是外部审计结论。后来的 GPT-4 Turbo、视觉正式化与价格调整，会改写可用性曲线；3 月 14 日留下的，是“更强、更贵、更不透明”同时成立的第一张快照。
