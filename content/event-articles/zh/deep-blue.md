...
六局的顺序扩大了比赛的象征性。卡斯帕罗夫先胜，深蓝追平，随后三和，最后一局决定整场结果。公众看到的是一项被视为高度智力的活动出现清楚的负分；IBM 展示的则是一项计算与领域工程。两种叙事在同一张比分表上重叠，却并不等价。赛后关于是否应允许调参、是否应公布日志的争论，也说明“正式比赛条件”本身仍可被继续定义。
...
技术论文还记录了评估函数中的数百个特征与可调参数，以及开局库如何避免在已知理论中浪费时间。专用芯片把生成走法、评估局面的热点路径固化，使“两亿”不是抽象口号，而是流水线吞吐。卡斯帕罗夫一方在赛后提出对调参与透明度的质疑；IBM 则强调比赛规则内的合法工程。争论本身表明：人机赛的“公平”取决于协议写得多细——时限、是否允许赛间修改、日志是否公开，都会改变公众读到的故事。
