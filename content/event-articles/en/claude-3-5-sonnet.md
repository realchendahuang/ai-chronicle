...
form: Commentary on model economics
narrativeCenter: "Claude 3.5 Sonnet made model tiers a choice among intelligence, speed, and price rather than a simple ranking by size"
emotionalSource: "Frontier capability beginning to feel less like a scarce audience with a flagship and more like a tool that could remain open all day"
avoid:
  - "Presenting vendor-reported benchmarks as unconditional industry findings"
  - "Writing the later success of Claude Code backward into this release"
...
Once a model becomes part of daily work, “best” is not a single coordinate. How long each request waits, how often a team can afford to call it, whether an entire document fits, and whether code edits remain reliable all change the answer. A flagship consulted only for exceptional problems may score higher while doing less of the organization's actual work. Claude 3.5 Sonnet placed what Anthropic presented as flagship-level performance in a profile more suitable for repeated use. “Workhorse” became a more revealing category than “largest.”

Artifacts, introduced with the model, supplied an interface for that change in use. Generated code, documents, and web content could appear in a separate workspace beside the conversation, where the user could inspect and continue editing them. The feature did not strengthen the underlying reasoning by itself. It changed the status of the output. A response no longer had to remain a message buried in a transcript; it could become an object under revision.
