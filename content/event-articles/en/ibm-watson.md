...
Watson's most durable achievement was neither the television persona nor the later breadth of the brand. It was the disciplined pipeline behind the podium: retrieve possibilities, make heterogeneous evidence compete, and require a system to estimate not only an answer, but whether it knows enough to speak.
