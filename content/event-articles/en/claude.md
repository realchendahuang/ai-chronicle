...
The “constitution” was neither law nor a certificate of safety. Principles can conflict, their interpretation is itself performed by models, and no list guarantees factual accuracy. Claude could hallucinate, misunderstand context, or refuse inconsistently. A measured tone did not make an answer true. Still, the method altered what laboratories were expected to explain: not only how capable a model was, but how its behavioral boundaries had been shaped.
...
Anthropic's recurring question was how increasingly capable systems might remain constrained and understandable. Claude did not resolve it. A product cannot close a research program merely by giving the research a name and an endpoint.

What Claude did was bring that question into an ordinary procurement and development decision. Alignment stopped being only a paper one might agree with. It became part of the reason an institution might choose one assistant over another—and part of the evidence that choice would still need to examine.
