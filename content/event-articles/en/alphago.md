...
Match conditions used Chinese rules and limited time; AlphaGo ran on distributed compute coordinating local and cloud machines. Public materials describe policy and value training stages and self-play at enormous scale. Move 37 and move 78 endure because they turn the abstract idea of out-of-distribution moves into coordinates one can click through in game software. The five-game series was both an architectural stress test and a peak of public transmission—learning proposes, search spends compute to check, self-play covers regions human game records miss.
