...
The experiment did not cooperate. A plain 34-layer network had higher error not only on validation data but on its training set. It had more representational capacity and fit the examples worse.
