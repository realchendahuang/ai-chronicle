...
narrativeCenter: "How a long regulation assigns abstract AI risk to providers, deployers, importers, and concrete use cases"
emotionalSource: "Technology markets keep time by version churn; law pursues them through clauses, liability, and phased application"
avoid:
  - Calling every AI system high-risk
  - Treating publication day as the day all obligations take effect at once
  - Substituting slogans for or against regulation for the text's scope
---
...
Years of drafting absorbed generative-AI shock by adding GPAI duties—the object deformed while the text was written. OJ publication is a bibliographic anchor; the real compliance calendar is clause-by-clause application dates. Annex definitions, standards, and guidance will decide how firms classify products; lobbying will orbit those borders. For model companies, training-content summaries and copyright policies pull dataset myth toward documentation; for deployers, human oversight and logging turn “we added a model” into auditable process. Institutional history is articles and schedules, not slogans.

Generative models spread during the legislative process and forced a further layer for general-purpose AI (GPAI). Upstream model providers and downstream deployers of applications can no longer fully hide in each other's responsibility gaps. GPAI models with systemic risk face stricter evaluation, incident reporting, and mitigation; copyright policies and summaries of training content carry related duties. The Act assigns roles—provider, deployer, importer, distributor—item by item, far more complex than a yes/no list. The same technique in different uses, operated by different actors, can produce different legal consequences.

The writing is necessarily slow. A product launch need only show what works today; law also considers intended purpose, reasonably foreseeable misuse, placing on the market, lifecycle oversight, redress, and enforcement. Nor did the whole apparatus fall on publication day. The regulation entered into force twenty days after publication; many provisions apply later on staggered timelines—prohibitions, GPAI duties, and high-risk requirements each have their own schedule. “The EU already regulates AI” is, in practice, years of institutional construction, not a single command on 12 July.
