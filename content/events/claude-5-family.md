...
id: claude-5-family
title: Claude 5 家族成形
subtitle: Fable 5 与 Sonnet 5 面向长期 Agent
date: '2026-06-30'
datePrecision: day
importance: B
eventType:
...
concepts:
  ...
  - coding-agent
  - tool-calling
summary: Anthropic 在六月先后推出 Claude Fable 5 与 Sonnet 5：前者面向长时间运行的高难度 Agent，后者强调速度与智能的综合平衡。
summaryEn: Anthropic released Claude Fable 5 on June 9 and Claude Sonnet 5 on June 30, 2026. The company positioned Fable for long-running, difficult agent work and Sonnet as the faster general-purpose tier; the performance claims remained vendor-reported at launch.
visual:
  src: /assets/events/claude-5-family.webp
  width: 2880
  height: 1620
  alt: 蝴蝶和飞蛾标本排列成数字 5
  altEn: Butterfly and moth specimens arranged in the shape of the numeral five
...
whyImportant: Claude 的代际命名从单纯的 Opus/Sonnet 4.x 扩展到新的能力层级，也表明模型竞争正在围绕“能否持续完成复杂工作”重新组织。
impact:
  developer: Claude 的主力模型分层更明确地对应长期 Agent、复杂代码和高吞吐工作。
