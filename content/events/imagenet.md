...
relatedEvents:
  ...
  - resnet
visual:
  src: /assets/events/imagenet.webp
  width: 1800
  height: 1012
  alt: ImageNet 论文展示的哺乳动物和交通工具 WordNet 层级样例
  altEn: ImageNet paper examples of mammal and vehicle branches in the WordNet hierarchy
