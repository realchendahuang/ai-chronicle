...
const events = defineCollection({
  ...
  schema: s.object({
    ...
    visual: s.object({
      ...
      rights: s.enum(['public-domain', 'cc', 'official-editorial', 'generated']),
      prompt: s.string().optional(),
    }).optional(),
    background: s.string().optional(),
    backgroundEn: s.string().optional(),
    whatHappened: s.string().optional(),
    whatHappenedEn: s.string().optional(),
    whyImportant: s.string().optional(),
    whyImportantEn: s.string().optional(),
    impact: s.object({
...
const companies = defineCollection({
  ...
  schema: s.object({
    ...
    logoSource: s.string().optional(),
    logoAlt: s.string().optional(),
    logoAltEn: s.string().optional(),
    slug: s.string(),
  }),
})
...
export default defineConfig({
  ...
  output: {
    ...
    assets: resolve(process.cwd(), '.generated/assets'),
    base: '/assets/',
    clean: true,
    name: '[name].json',
  },
